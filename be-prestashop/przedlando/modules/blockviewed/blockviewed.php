...
class BlockViewed extends Module
{
	...
	{
		return (parent::install() && $this->registerHook('header') && $this->registerHook('displayBeforeFooter') && $this->registerHook('leftColumn') && Configuration::updateValue('PRODUCTS_VIEWED_NBR', 2));
